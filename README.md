...
* Once your server is up and running, the URL you'll be able to hit from within your app is `http://localhost:5002`. You will however need an authentication header on all the calls except the login call.
